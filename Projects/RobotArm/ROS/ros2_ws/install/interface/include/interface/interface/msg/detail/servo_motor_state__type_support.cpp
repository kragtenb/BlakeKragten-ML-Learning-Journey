...
{
  new (message_memory) interface::msg::ServoMotorState(_init);
}

void ServoMotorState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<interface::msg::ServoMotorState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoMotorState_message_member_array[2] = {
  {
    ...
    offsetof(interface::msg::ServoMotorState, name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(interface::msg::ServoMotorState, degree),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServoMotorState_message_members = {
  ...
  2,  // number of fields
  sizeof(interface::msg::ServoMotorState),
...
{
  return &::interface::msg::rosidl_typesupport_introspection_cpp::ServoMotorState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, ServoMotorState)() {
  return &::interface::msg::rosidl_typesupport_introspection_cpp::ServoMotorState_message_type_support_handle;
}
