...
#include "interface/msg/detail/servo_motor_state__rosidl_typesupport_fastrtps_c.h"
...
using _ServoMotorState__ros_msg_type = interface__msg__ServoMotorState;
...
size_t get_serialized_size_interface__msg__ServoMotorState(
  const void * untyped_ros_message,
...
static uint32_t _ServoMotorState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interface__msg__ServoMotorState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interface
size_t max_serialized_size_interface__msg__ServoMotorState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface__msg__ServoMotorState;
    is_plain =
      (
...
static size_t _ServoMotorState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interface__msg__ServoMotorState(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interface, msg, ServoMotorState)() {
