...
static const _ServoMotorStateChange_type_support_symbol_names_t _ServoMotorStateChange_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, ServoMotorStateChange)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interface, msg, ServoMotorStateChange)),
  }
};
...
{
  return &::interface::msg::rosidl_typesupport_cpp::ServoMotorStateChange_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interface, msg, ServoMotorStateChange)() {
  return get_message_type_support_handle<interface::msg::ServoMotorStateChange>();
}
